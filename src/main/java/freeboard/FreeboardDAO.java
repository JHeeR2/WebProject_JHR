	...
	//검색 조건에 맞는 게시물 목록 반환
		public List<FreeboardDTO> selectList(Map<String, Object> map){
			...
			try {
				...
				System.out.println("freeboard 게시물 조회 중 예외 발생");
				e.printStackTrace();
			}
		...
		public int selectCount(Map<String, Object> map) {
			...
			try {
				...
				System.out.println("Freeboard 게시물 카운트 중 예외 발생");
				e.printStackTrace();
			}
		...
		public List<FreeboardDTO> selectListPage(Map<String, Object> map) {
		    ...
		    String query = "SELECT * FROM ( "
		        ...
		        + "        f.visitcount, "
		        + "        f.postdate, "
		        + "        ROW_NUMBER() OVER (ORDER BY f.idx DESC) AS rNum "
		        + "    FROM freeboard f "
		...
		public FreeboardDTO selectView(String idx) {
			...
			FreeboardDTO dto = new FreeboardDTO(); //DTO 객체 생성
			...
			try {
				...
				System.out.println("freeboard 게시물 상세보기 중 예외 발생");
				e.printStackTrace();
			}
			return dto; // 결과 반환
		}
		...
		public void updateVisitCount(String idx) {
			...
			try {
				...
				*/
				...
				System.out.println("freeboard게시물 조회수 증가 중 예외 발생");
				e.printStackTrace();
			}
		}
		...
		public int deletePost(String idx) {
			...
			try {
				...
				System.out.println("freeboard deletePost 자료실 게시물 삭제 중 예외 발생");
				e.printStackTrace();
			}
			return result;
		}
		...
		public int updatePost(FreeboardDTO dto) {
			...
			try {
				...
				String query = "UPDATE freeboard SET title=?, content=? WHERE idx=? and user_id=?";
