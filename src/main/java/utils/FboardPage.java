...
public class FboardPage {
	/*
	totalCount : 전체 게시물의 갯수
	pageSize: web.xml에 설정한 값. 한페이지에 출력할 게시물 수
	blockPage : 위와 동일. 한 블럭당 출력할 페이지번호 수
	pageNum: 현재 진입해 있는 페이지번호
	...
	*/
	public static String pagingStr(int totalCount, int pageSize, int blockPage, int pageNum, String reqUrl) {
		...
		/*
		전체 페이지 수 계산
		: ceil(전체 게시물수 / 한 페이지당 게시물 수) => 결과를 무조건 올림처리
		하여 계산한다. 
		*/
		...
		1의 결과가 나온다
		각 1~5페이지 일때는 pageTemp가 1이 되어 반복하면서 출력할 수 있다. 
		*/
