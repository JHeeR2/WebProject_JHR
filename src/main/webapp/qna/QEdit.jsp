...
<body>
    ...
    <div class="container">
        <h2>Q&A 게시판 글 수정</h2>
        <form name="writeFrm" method="post" action="../qna/QEdit.do" onsubmit="return validateForm(this);">
       	<input type="hidden" name="idx" value="${ dto.idx }" />
       	<input type="hidden" name="id" value="${ dto.user_id }">
        <div class="button-group">
        	<button type="reset" class="button">모두 지우기</button>
        	<button type="button" class="button" onclick="location.href='QList.do'">목록 바로가기</button>
        </div>
